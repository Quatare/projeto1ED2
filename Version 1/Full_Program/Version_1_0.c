...
#include <string.h>
#include <time.h>
#include "memoria.h" // Estrutura representativa dos blocos de memória
#include "processo.h" // Estrutura representativa dos processos

// Função que faz a inserção de elementos nas Listas Principais (RoundRobin e Prioridade)
